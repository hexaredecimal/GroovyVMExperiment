...
<p>
  What if We used the JVM as a <b>*LIVE Environment*</b> for <b>Quick Experiment</b> and </b>Recreational Programming</b>?
...
JMenuItem app = new JMenuItem("Welcome");
app.addActionListener {event -> 
    desktop.add(WelcomeApp.run());
}
